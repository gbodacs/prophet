...
<body>
  ...
  <main class="app-shell">
    ...
    <div class="app-layout">
      <aside id="sidebar-nav" class="sidebar-nav" aria-label="Operations menu">
        <button
          type="button"
          id="sidebar-toggle"
        ...
        >
          ...
          <span class="sidebar-toggle-text">Menü</span>
        </button>

        <nav id="sidebar-menu" class="sidebar-menu" aria-label="Korábbi műveletek">
          <p class="sidebar-title">Műveletek</p>
          <ul id="sidebar-operations-list" class="sidebar-list"></ul>
        </nav>
      </aside>
        ...
        <section id="list-tab" class="tab-panel" aria-labelledby="List Successful Runs">
          ...
          <div class="grid">
            ...
            <div class="card">
              ...
              <div id="selected-run-link" class="muted"></div>
